...
class G1Cfg(LeggedRobotCfg):
    ...
    class asset(LeggedRobotCfg.asset):
        ...
        class chair:
            base_size = [0.3, 0.3, 0.01]
            use_random = True

            random_size = use_random
            scale_range_x = [1.0, 1.5]
            scale_range_y = [1.0, 1.5]
            ...
            chair_height_mean = 0.325
            chair_height_var = 0.125
    ...
    class dataset:
        motion_file = "{LEGGED_GYM_ROOT_DIR}/resources/config/sitdown.yaml"
...
class G1CfgPPO( LeggedRobotCfgPPO ):
    ...
    class runner( LeggedRobotCfgPPO.runner ):
        ...
        run_name = 'sitdown_coef0.35'
        experiment_name = 'amp_sitdown'
        logger = 'tensorboard'  # ['tensorboard', 'wandb']
        wandb_project = 'amp_sitdown'
