...
class G1Cfg(LeggedRobotCfg):
    ...
    class asset(LeggedRobotCfg.asset):
        ...
        marker_file = "{LEGGED_GYM_ROOT_DIR}/resources/objects/location_marker.urdf"
        name = "g1"
    ...
    class dataset:
        motion_file = "{LEGGED_GYM_ROOT_DIR}/resources/config/standup.yaml"
...
class G1CfgPPO( LeggedRobotCfgPPO ):
    ...
    class runner( LeggedRobotCfgPPO.runner ):
        ...
        run_name = 'standup_coef0.35'
        experiment_name = 'amp_standup'
        logger = 'tensorboard'  # ['tensorboard', 'wandb']
        wandb_project = 'amp_standup'
