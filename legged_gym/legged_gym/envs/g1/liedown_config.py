...
class G1Cfg(LeggedRobotCfg):
    ...
    class asset(LeggedRobotCfg.asset):
        ...
        object_file = "{LEGGED_GYM_ROOT_DIR}/resources/objects/sofa.urdf"
        name = "g1"
        ...
        class chair:
            ...
            skill = ["loco", "lieDown"]
            skill_init_prob = [0.8, 0.2]

            chair_height_mean = 0.3
            chair_height_var = 0.15

            thresh_tag = [0.7, 2.0]
            far_pos_offset = 0.2
            pos_noise_scale = 0.1
            ang_noise_offset = np.deg2rad(5)
    ...
    class dataset:
        motion_file = "{LEGGED_GYM_ROOT_DIR}/resources/config/liedown.yaml"
    ...
    class amp:
        amp_coef = 0.35
        num_one_step_obs = 1 + 29 + 5 * 3 + 3 + 3 + 6 + 3 + 1
        window_length = 10
...
class G1CfgPPO( LeggedRobotCfgPPO ):
    ...
    class runner( LeggedRobotCfgPPO.runner ):
        ...
        run_name = 'liedown_coef0.35'
        experiment_name = 'amp_liedown'
        logger = 'tensorboard'  # ['tensorboard', 'wandb']
        wandb_project = 'amp_liedown'
